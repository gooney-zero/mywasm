        ...
        <>
          ...
          <section class="box-border min-c pb-5">
            <div class="py-0 px-4">
              ...
              <div class="mb-3">
                <Button onclick={self.link.callback(|e|{Msg::PrimaryClick(e)})}  text={"主要按钮"} class={margin_right_4} button_type={ButtonType::Primary}/>
                <Button text={"信息按钮"} class={margin_right_4} button_type={ButtonType::Info}/>
                <Button text={"默认按钮"} />
              </div>
              <Button text={"危险按钮"} class={margin_right_4} button_type={ButtonType::Danger}/>
              <Button text={"警告按钮"} class={margin_right_4} button_type={ButtonType::Warning}/>
            </div>
            <div class="py-0 px-4">
              <h2 class="pt-5 pl-0 m-0 pr-4 pb-4 text-gray-400 font-normal text-sm">{"朴素按钮"}</h2>
              <Button text={"朴素按钮"} class={margin_right_4} plain={true} button_type={ButtonType::Primary}/>
            ...
            <div class="py-0 px-4">
              ...
              <Button text={"禁用状态"} class={margin_right_4} disabled={true} button_type={ButtonType::Primary}/>
            ...
            <div class="py-0 px-4">
              ...
              <Button text={"方形按钮"} class={margin_right_4} square={true} button_type={ButtonType::Primary}/>
